# 📄 ДОМАШНЕЕ ЗАДАНИЕ №1: Системный анализ сервиса «Прокачу»

Добро пожаловать в репозиторий с материалами обследования и требованиями к мобильному приложению сервиса аренды велосипедов «Прокачу».
